...
class LabelColorListItemAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(holder is MyViewHolder){
            val MainView: View = holder.itemView.findViewById(R.id.view_main)
            MainView.setBackgroundColor(Color.parseColor(item))
            if(item==mSelectedColor){
                var ImageView: ImageView = holder.itemView.findViewById(R.id.iv_selected_color)
